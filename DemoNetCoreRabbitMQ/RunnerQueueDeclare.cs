...
namespace DemoNetCoreRabbitMQ
{
    public class RunnerQueueDeclare
    {
        ...
        public void Run()
        {
            ...
            channelProducer.QueueDeclare(_queueName, false, false, false, null);
            // 每次只能向消費者傳送一條資訊,再消費者未確認之前,不再向他傳送資訊
            // channelProducer.BasicQos(0, 1, false);
            ...
            do
            {
                ...
                {
                    var basicGetResult = channelConsumer.BasicGet(_queueName, false);
